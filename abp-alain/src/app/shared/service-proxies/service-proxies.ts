...
export class ChatServiceProxy {
     ...
     * @return Success
     */
    findMessageAsync(id: number | null | undefined, userId: number | null | undefined): Observable<ChatMessage> {
    ...
    protected processFindMessageAsync(response: HttpResponseBase): Observable<ChatMessage> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class LanguageServiceProxy {
     ...
     * @targetLanguageName (optional) 
     * @targetValueFilter (optional) 
     * @filterText (optional) 
     * @return Success
     */
    getLanguageTexts(maxResultCount: number | null | undefined, skipCount: number | null | undefined, sorting: string | null | undefined, sourceName: string | null | undefined, baseLanguageName: string | null | undefined, targetLanguageName: string | null | undefined, targetValueFilter: string | null | undefined, filterText: string | null | undefined): Observable<PagedResultDtoOfLanguageTextListDto> {
...
export class TenantDashboardServiceProxy {
    ...
    protected processGetWorldMap(response: HttpResponseBase): Observable<GetWorldMapOutput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getServerStats(input: any | null | undefined): Observable<GetServerStatsOutput> {
        ...
        return this.http.request("get", url_, options_).flatMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetServerStats(<any>response_);
                } catch (e) {
    ...
    protected processGetServerStats(response: HttpResponseBase): Observable<GetServerStatsOutput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class ChatMessage implements IChatMessage {
    ...
    message!: string;
    creationTime!: moment.Moment | undefined;
    side!: ChatMessageSide | undefined;
    readState!: ChatMessageReadState | undefined;
    receiverReadState!: ChatMessageReceiverReadState | undefined;
    sharedMessageId!: string | undefined;
    id!: number | undefined;
...
export class TimeLineItem implements ITimeLineItem {
    ...
    autherName!: string | undefined;
    longDate!: string | undefined;
    shortDate!: string | undefined;
    titleDate!: string | undefined;
